        ...
        for epoch in range(1, args.num_epoch + 1):
            ...
            for batch in range(num_batch):
                ...
                if loss_status.status == "A":
                    ...
                    client_backward(sfl, pool, gradient_dict, args)
                else:
